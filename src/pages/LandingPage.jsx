...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 flex flex-col">
      ...
      {/* --- HERO SECTION --- */}
      <header className="relative h-screen w-full overflow-hidden flex items-center justify-center pt-10">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl flex flex-col items-center">
          ...
          {/* Logo Sopra (Couleurs originales + Transparence) */}
          <div className="mb-4 bg-white/40 backdrop-blur-md p-3 rounded-xl border border-white/50 inline-block shadow-xl">
            <img 
              src={sopraLogo} 
              alt="Sopra Steria" 
          ...
          <p className="text-lg md:text-xl text-slate-200 mb-8 font-light max-w-2xl">
            Surveillez vos ruches à distance, en temps réel, et agissez pour la biodiversité avec notre solution connectée.
          </p>
          <button onClick={() => navigate('/login')} className="bg-amber-500 text-cyan-950 px-8 py-3 rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-xl">
            ACCÉDER À LA PLATEFORME
          </button>
        </div>
      </header>

      {/* --- SECTION 1 : LES ABEILLES --- */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 bg-white p-10 rounded-2xl shadow-xl border-l-8 border-amber-400">
            ...
            <p className="text-slate-700 leading-relaxed">
              Leur survie est aujourd'hui menacée par le changement climatique. Les protéger est un enjeu majeur pour notre biodiversité et notre avenir.
            </p>
          </div>
      ...
      {/* --- SECTION 2 : POURQUOI UNE RUCHE CONNECTÉE --- */}
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-cyan-900 p-10 rounded-2xl shadow-xl text-white">
            ...
            <p className="text-lg leading-relaxed mb-4">
              La technologie IoT permet de limiter les interventions intrusives. Chaque ouverture de ruche stresse la colonie.
            </p>
            <p className="text-lg leading-relaxed">
              Notre solution remonte des données en temps réel pour anticiper les besoins des abeilles et intervenir uniquement quand c'est nécessaire.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-white text-slate-800 py-16 px-6 border-t border-slate-200 mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-10">
          ...
          <div className="text-center w-full pt-8 flex flex-col items-center gap-4 border-t border-slate-100">
